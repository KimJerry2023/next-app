    ...
    <AuthenticatedLayout>
      <div className="page-content p-4">
        ...
        <div className="mb-6">
          ...
          <p className="text-muted-foreground">理财产品与投资管理</p>
        </div>

        {/* 资产概览 */}
        <div className="bg-card rounded-lg shadow-sm p-6 mb-6 border border-border">
          <h2 className="text-lg font-semibold text-card-foreground mb-4">投资概览</h2>
          <div className="grid grid-cols-3 gap-4">
            <div className="text-center">
              <p className="text-sm text-muted-foreground mb-1">总投资</p>
              <p className="text-xl font-bold text-card-foreground">¥70,000</p>
            </div>
            <div className="text-center">
              <p className="text-sm text-muted-foreground mb-1">当前价值</p>
              <p className="text-xl font-bold text-green-500">¥73,190</p>
            </div>
            <div className="text-center">
        ...
        <div className="bg-card rounded-lg shadow-sm mb-6 border border-border">
          <div className="px-4 py-3 border-b border-border">
            <h2 className="text-lg font-semibold text-card-foreground">我的投资</h2>
          </div>
          <div className="divide-y divide-border">
            {myInvestments.map((investment) => (
              <div key={investment.id} className="px-4 py-4">
                <div className="flex items-center justify-between mb-2">
                  <h3 className="font-medium text-card-foreground">{investment.name}</h3>
                  <span className="text-sm text-green-500">{investment.profitRate}</span>
                </div>
        ...
        <div className="bg-card rounded-lg shadow-sm border border-border">
          <div className="px-4 py-3 border-b border-border">
            <h2 className="text-lg font-semibold text-card-foreground">推荐产品</h2>
          </div>
          <div className="divide-y divide-border">
            {wealthProducts.map((product) => (
              <div key={product.id} className="px-4 py-4">
                ...
                <button className="w-full mt-3 bg-primary text-primary-foreground py-2 px-4 rounded-lg text-sm font-medium hover:bg-primary/90 transition-colors">
                  立即投资
                </button>
              </div>
            ))}
